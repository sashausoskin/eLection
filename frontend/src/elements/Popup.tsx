...
const Popup = () => {
    ...
    return <>
        {popupBackgroundAnimation((bgStyle, bgItem) => (bgItem &&
            <animated.div style={bgStyle} className='popupBackground'>
            {popupAnimation((style, item) => (item &&
                <animated.div style={style} className='popupContainer'>
